...
def main(input_json_path: str, count: int = 100,
    ...
    for _ in range(count):
        sentence = model.generate_sentence(test_output=rejection_origin_text)
        print(sentence)
...
if __name__ == "__main__":
    ...
    main(args.input_json_path, count=args.count,
